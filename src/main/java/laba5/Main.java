...
// TODO: Сделать особую запись ошибок в случае если работает автоматизированный вывод команд. (Добавить в IO менеджер метод printError, и перенаправлять поток err)
